...
export const UniforLogo: Component<Props> = (props) => {
  const { color = "white", height = 24 } = props;
  const viewBoxWidth = 120.6;
  const viewBoxHeight = 51.1;
      ...
      <g>
        <g>
          <g>
            <path
              fill={color}
              d="M45.4,34.2h-6.2c0,0,0,0,0,0c1.5-2.6,2.4-5.7,2.4-9c0-3-0.7-5.8-2-8.2c0,0,0.1,0,0.1,0h5.8
          ...
          <g>
            <path
              fill={color}
              d="M69.7,27.7c0,1.2-0.3,2.1-1,2.7c-0.6,0.6-1.5,1-2.7,1c-1.2,0-2.1-0.3-2.7-1c-0.6-0.6-1-1.6-1-2.8V17.3h-2.9
            ...
            <path
              fill={color}
              d="M81.7,22.4c-0.8,0-1.5,0.2-2.1,0.5c-0.6,0.3-1.1,0.8-1.5,1.3l-0.2-1.5h-2.6V34h2.8v-6.1
            ...
            <path
              fill={color}
              d="M89.7,17.1c-0.5,0-0.9,0.2-1.2,0.5c-0.3,0.3-0.5,0.7-0.5,1.2c0,0.5,0.2,0.9,0.5,1.2c0.3,0.3,0.7,0.5,1.2,0.5
              c0.5,0,0.9-0.2,1.2-0.5c0.3-0.3,0.5-0.7,0.5-1.2c0-0.5-0.2-0.9-0.5-1.2C90.5,17.3,90.1,17.1,89.7,17.1z"
            />
            <rect x="88.3" y="22.7" width="2.8" height="11.2" fill={color} />
            <path
              fill={color}
              d="M98,17c-0.8,0-1.5,0.1-2.1,0.4c-0.6,0.3-1.1,0.8-1.4,1.4c-0.3,0.6-0.5,1.5-0.5,2.5v1.4h-1.6V25H94V34h2.8V25
            ...
            <path
              fill={color}
              d="M108.9,23.1c-0.9-0.5-1.9-0.8-3.1-0.8c-1.2,0-2.2,0.3-3.1,0.8c-0.9,0.5-1.6,1.2-2.1,2.1
            ...
            <path
              fill={color}
              d="M119.9,22.6c-0.2,0-0.4,0-0.6,0c-0.9,0-1.6,0.2-2.2,0.7c-0.4,0.3-0.7,0.7-0.9,1.2l-0.2-1.7h-2.6V34h2.8v-5.5
